...
![Six-cell concordance matrix](outputs/figures/concordance.png)

**Every claim on the Jeffreys evidence spectrum**
...
**Prior-scale robustness (narrow / primary / wide)**

![Prior robustness](outputs/figures/prior_robustness.png)

(near-threshold detail: [`prior_robustness_zoom.png`](outputs/figures/prior_robustness_zoom.png))
